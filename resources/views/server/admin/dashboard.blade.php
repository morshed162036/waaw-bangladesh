                    ...
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-0 line-ellipsis">Total Admin</p>
                    ...
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-0 line-ellipsis">Total Employee</p>
                    ...
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-0 line-ellipsis">Total Laborer</p>
                                <h2 class="mb-0">{{ $labore }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="card-content">
                            <div class="card-body">
                                <div class="badge-circle badge-circle-lg badge-circle-light-primary mx-auto my-1">
                                    <i class="bx bx-user-voice font-medium-5"></i>
                                </div>
                                <p class="text-muted mb-0 line-ellipsis">Total Client</p>
                    ...
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-0 line-ellipsis">Project Based Client</p>
                                <h2 class="mb-0">{{ $project_client }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-0 line-ellipsis">Sale Based Client</p>
                                <h2 class="mb-0">{{ $sale_client }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-0 line-ellipsis">Total Supplier</p>
                    ...
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-0 line-ellipsis">Total Invoice</p>
                    ...
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-0 line-ellipsis">Purchase Invoice</p>
                                <h2 class="mb-0">{{ $purchase_invoice }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-0 line-ellipsis">Sale Invoice</p>
                                <h2 class="mb-0">{{ $sale_invoice }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-0 line-ellipsis">Project Invoice</p>
                                <h2 class="mb-0">{{ $project_invoice }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="col-xl-2 col-md-4 col-sm-6">
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                <div class="badge-circle badge-circle-lg badge-circle-light-danger mx-auto my-1">
                                    <i class="bx bxs-buoy font-medium-5"></i>
                                </div>
                                <p class="text-muted mb-0 line-ellipsis">Total Project</p>
                    ...
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-0 line-ellipsis">Running Project</p>
                                <h2 class="mb-0">{{ $running_project }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="card text-center">
                        <div class="card-content">
                            <div class="card-body">
                                ...
                                <p class="text-muted mb-0 line-ellipsis">Complete Project</p>
                                <h2 class="mb-0">{{ $complete_project }}</h2>
                            </div>
                        </div>
                    </div>
                </div>
